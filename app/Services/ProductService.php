...
class ProductService
{
    ...
    {
        return $this->productRepository->allProductsWithMainImages()->get();
    }

    public function paginateAllProductsWithMainImages()
    {
        $pageSize = 15;
        $cntProducts = $this->productRepository->allProductsWithMainImages()->count();

        $products = $this->productRepository->allProductsWithMainImages()->paginate($pageSize);
        $products->total_results = $cntProducts;
